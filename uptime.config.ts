...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/qintengyi/UptimeFlare', label: 'GitHub' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      statusPageLink: 'https://api.xiaoyyua.top',
      hideLatencyChart: false,
      expectedCodes: [404],
      timeout: 10000,
    },
    {
      ...
      name: '卡网服务',
      method: 'GET',
      target: 'https://shop.xiaoyyua.top',
  ...
  notification: {
    ...
    webhook: {
      ...
      url: 'http://192.168.1.2:28080/3qiNmdFp4xvQ4562mCTphc/?icon=https://photogallery.oss-cn-hangzhou.aliyuncs.com/photo/1593684685990577/340784693905362914b35b406040dcccc669e.PNG',
